...
print("2)")
for i in range(datetime.datetime.now().year, datetime.datetime.now().year+5):
    print(easter(i))

christmas = datetime.datetime.now().year
while(datetime.date(christmas, 12,24).weekday()!=6):
    christmas += 1
    break
print(f"3) {christmas}")