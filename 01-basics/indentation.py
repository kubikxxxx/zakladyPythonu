...
def vypsaniCisla(cislo1, cislo2):
    """
    Tato funkce uhádne číslo a následně ho vypíše:
    """
    if cislo1 > cislo2:
        for ii in range(0, cislo1):
            sleep(2)
            if ii == cislo2:
                print("zadane cislo je: " + cislo1)


print(vypsaniCisla.__doc__)
vypsaniCisla(15, 6)